...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        df_all=filtered_df.groupby('Launch Site')['class'].count().reset_index()
        fig = px.pie(df_all, values='class', 
        names='Launch Site', 
        title='Site wise successful launch')
        return fig
    else:
        df_site=filtered_df[filtered_df['Launch Site']==entered_site].groupby('class')['Launch Site'].count().reset_index()
        fig = px.pie(df_site, values='Launch Site', 
        names='class', 
